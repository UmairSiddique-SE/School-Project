...
const MOCK_ROUTES: TransportRoute[] = [
  {
    ...
    distance: 15.5,
    description: 'Main route covering northern areas of the city',
    stops: ['Central Bus Station', 'Town Hall', 'Library Crossing', 'Main Market', 'School Gate'],
  ...
  },
  {
    ...
    endPoint: 'School Back Gate',
    distance: 12.3,
    description: 'Route covering southern residential areas',
    stops: ['Railway Station', 'City Hospital', 'Sports Complex', 'School Back Gate'],
  ...
  },
  {
    ...
    startPoint: 'East Mall',
    endPoint: 'School Side Gate',
    distance: 18.7,
    description: 'Route covering eastern commercial and residential zones',
    stops: ['East Mall', 'Tech Park', 'Residential Area A', 'School Side Gate'],
...
const MOCK_VEHICLES: Vehicle[] = [
  {
    ...
    currentLocation: {
      lat: 24.8607,
      lng: 67.0011,
      address: 'Near Central Bus Station',
  ...
  },
  {
    ...
    currentLocation: {
      lat: 24.8605,
      lng: 67.0015,
      address: 'On Route - Railway Station',
      lastUpdate: new Date().toISOString(),
    },
    currentSpeed: 35,
    isMoving: true,
  ...
  },
  {
    ...
    driverId: 'd3',
    driverName: 'Chaudhry Rashid',
    driverPhone: '+92 333 9988776',
