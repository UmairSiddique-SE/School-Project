...
export default function App() {
  return <ThemeProvider><AuthProvider><BrowserRouter><Routes>
    ...
    <Route path="/:schoolSlug" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
      ...
      <Route path="teacher" element={<TeacherPortal />} /><Route path="teacher/classes" element={<MyClasses />} /><Route path="teacher/attendance" element={<TeacherAttendance />} /><Route path="teacher/grades" element={<Grades />} />
    </Route>
