...
export class AcademicsController {
  ...
  @Get('announcements') @Roles('SCHOOL_ADMIN', 'TEACHER', 'STUDENT')
  ...
  @Get('routes') @Roles('SCHOOL_ADMIN', 'TEACHER')
  ...
  @Get('vehicles') @Roles('SCHOOL_ADMIN', 'TEACHER')
  getVehicles(@CurrentUser() user: any) { return this.academicsService.getVehicles(user.schoolId); }
  @Post('vehicles') @Roles('SCHOOL_ADMIN')
  createVehicle(@CurrentUser() user: any, @Body() dto: any) { return this.academicsService.createVehicle(user.schoolId, dto); }
  @Delete('vehicles/:id') @Roles('SCHOOL_ADMIN')
  deleteVehicle(@CurrentUser() user: any, @Param('id') id: string) { return this.academicsService.deleteVehicle(id, user.schoolId); }

  @Get('transport/assignments') @Roles('SCHOOL_ADMIN', 'TEACHER')
  getTransportAssignments(@CurrentUser() user: any) { return this.academicsService.getTransportAssignments(user.schoolId); }
  @Post('transport/assignments') @Roles('SCHOOL_ADMIN')
  createTransportAssignment(@CurrentUser() user: any, @Body() dto: any) { return this.academicsService.createTransportAssignment(user.schoolId, dto); }
  @Patch('transport/assignments/:id') @Roles('SCHOOL_ADMIN')
  updateTransportAssignment(@CurrentUser() user: any, @Param('id') id: string, @Body() dto: any) { return this.academicsService.updateTransportAssignment(id, user.schoolId, dto); }
  @Delete('transport/assignments/:id') @Roles('SCHOOL_ADMIN')
  deleteTransportAssignment(@CurrentUser() user: any, @Param('id') id: string) { return this.academicsService.deleteTransportAssignment(id, user.schoolId); }
}
